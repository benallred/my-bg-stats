...
4. Year in Review - Social & Locations: Total number of other players (excluding self), total solo-only days (no multiplayer games that day), most common player count, most common day to play, biggest gaming session (most players in single session/day), display list of players played with (implementation details TBD: anonymization, formatting, etc.)
